...
java -Xmx4g -jar $1/${snpEFFdir}/snpEff.jar eff -c $1/${snpEFFdir}/snpEff.config$ -v GRCh37.75 -lof -csvStats -nextProt -sequenceOntology {datadir1}/vcfinput_mr.vcf > {datadir1}/vcfinput_mr_eff.vcf
...
perl $1/${VEPdir}/variant_effect_predictor.pl -i {datadir1}/vcfinput_mr.vcf --offline --output_file {datadir1}/vcfinput_mr_vep.vcf --everything --vcf --cache --dir $1/.vep/
...
perl $1/${bindir1}/41_CCDS_collapser_3.0.pl {datadir1}/gtf_tabladef_sorted_by_SYMBOL.txt {datadir1}/snpeff_NMD.txt {datadir1}/snpeff_NMD_CCDS.txt {datadir1}/snpeff_derived_NMD.txt {datadir1}/snpeff_derived_NMD_CCDS.txt {datadir2}/gtf_output_ENSG.txt {datadir2}/gtf_output_ENSG_CCDS.txt {datadir2}/gtf_output_ENST.txt {datadir2}/gtf_output_ENST_CCDS.txt {datadir2}/ENST_table_full_condensed.txt {datadir2}/ENST_table_full_condensed_CCDS.txt {datadir3}/appris_principal_isoform_gencode_19_15_10_2014.txt {datadir3}/appris_principal_isoform_gencode_19_15_10_2014_CCDS.txt {datadir3}/Pervasive.txt {datadir3}/Pervasive_CCDS.txt {datadir1}/snpeff_first_table.txt {datadir1}/snpeff_first_table_CCDS.txt
...
perl $1/${bindir1}/27_key_NMD_5.0_3.0.pl {datadir1}/out_vep_parsed.txt {datadir2}/NMD_table.txt {datadir2}/ENST_table_full_condensed.txt {datadir1}/vep_NMD.txt
...
perl $1/${bindir1}/27_key_NMD_5.0_DERIVED_STOPS_2.0.pl {datadir1}/vep_derived_PTCS_API_independent.txt {datadir1}/out_vep_parsed.txt {datadir2}/NMD_table.txt {datadir2}/ENST_table_full_condensed.txt {datadir1}/vep_derived_NMD.txt
...
perl $1/${bindir1}/40_tabla_PEJMAN_16_def_2.0.pl {datadir1}/vep_first_table.txt {datadir1}/vep_NMD.txt {datadir1}/vep_derived_NMD.txt {datadir2}/gtf_output_ENST.txt {datadir2}/gtf_output_ENSG.txt {datadir2}/ENST_table_full_condensed.txt {datadir3}/appris_principal_isoform_gencode_19_15_10_2014.txt {datadir3}/Pervasive.txt {datadir1}/Matrix_vep.txt

perl $1/${bindir1}/41_CCDS_collapser_3.0.pl {datadir1}/gtf_tabladef_sorted_by_SYMBOL.txt {datadir1}/vep_NMD.txt {datadir1}/vep_NMD_CCDS.txt {datadir1}/vep_derived_NMD.txt {datadir1}/vep_derived_NMD_CCDS.txt {datadir2}/gtf_output_ENSG.txt {datadir2}/gtf_output_ENSG_CCDS.txt {datadir2}/gtf_output_ENST.txt {datadir2}/gtf_output_ENST_CCDS.txt {datadir2}/ENST_table_full_condensed.txt {datadir2}/ENST_table_full_condensed_CCDS.txt {datadir3}/appris_principal_isoform_gencode_19_15_10_2014.txt {datadir3}/appris_principal_isoform_gencode_19_15_10_2014_CCDS.txt {datadir3}/Pervasive.txt {datadir3}/Pervasive_CCDS.txt {datadir1}/vep_first_table.txt {datadir1}/vep_first_table_CCDS.txt

perl $1/${bindir1}/42_tabla_PEJMAN_15.0_version_paralel_4.0.pl {datadir1}/vep_first_table_CCDS.txt {datadir1}/vep_NMD_CCDS.txt {datadir1}/vep_derived_NMD_CCDS.txt {datadir2}/gtf_output_ENST_CCDS.txt {datadir2}/gtf_output_ENSG_CCDS.txt {datadir2}/ENST_table_full_condensed_CCDS.txt {datadir3}/appris_principal_isoform_gencode_19_15_10_2014_CCDS.txt {datadir3}/Pervasive_CCDS.txt {datadir1}/Matrix_vep_CCDS.txt

perl $1/${bindir1}/53BIS_Fuse_Matrix\&Gene_based.pl {datadir1}/Matrix_vep.txt {datadir3}/pRDG2.txt {datadir3}/Genes_AllInnateImmunity.txt {datadir3}/Genes_Antiviral.txt {datadir3}/Genes_ISGs.txt {datadir3}/Genes_OMIMrecessive.txt {datadir3}/RVIS2.txt {datadir4}/Matrix_vep_added_gene_based_scores.txt

perl $1/${bindir1}/53BIS_Fuse_Matrix\&Gene_based.pl {datadir1}/Matrix_vep_CCDS.txt {datadir3}/pRDG2.txt {datadir3}/Genes_AllInnateImmunity.txt {datadir3}/Genes_Antiviral.txt {datadir3}/Genes_ISGs.txt {datadir3}/Genes_OMIMrecessive.txt {datadir3}/RVIS2.txt {datadir4}/Matrix_vep_CCDS_added_gene_based_scores.txt
