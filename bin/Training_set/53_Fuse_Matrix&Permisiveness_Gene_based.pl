...
{
	#~ Input=Matrix_snpeff_CCDS_added_tags.txt
...
if (open(OUTPUT, '>'.$output))
{
	print OUTPUT "baseNCBI37\tAlleles_REF>ALT\tGeneNameHGNC\tNumIsoformsInQueryGene\tratioIsoformsBearingTheVariant\t".
				...
				"PEJMAN5\tPEJMAN6\tPathogenicity_Tag\tCredible_Tag_-1_rare_0_not_credible_1_common\tLocation_Tag\t".
