##	Script to parse the output file of VEP joint calls expressed as minimal representation and undo cryptic alleles. 2014.
...
{
	# Input: outfile of VEP
		
		#CHROM  POS     ID      REF     ALT     QUAL    FILTER  INFO
		#1       69620   .       TA      T       100.0   PASS    CSQ=-|ENSG00000186092|ENST00000335137|Transcript|frameshift_variant&feature_truncation|531|531|177|||TMP_ESP_1_69621_69621|ENSP00000334393||||Pfam_domain:PF00001&Pfam_domain:PF10320&Prints_domain:PR00245&PROSITE_profiles:PS50262&Superfamily_domains:SSF81321|||protein_coding|CCDS30547.1||||||YES|OR4F5|HGNC||||||1/1|||1,-||ENSR00000278218|RegulatoryFeature|regulatory_region_variant||||||TMP_ESP_1_69621_69621||||||||||||||||||||||||||
		#1       874816  .       C       CT      100.0   PASS    CSQ=T|ENSG00000187634|ENST00000342066|Transcript|frameshift_variant&feature_elongation|765-766|682-683|228|||rs200996316&COSM1344644|ENSP00000342313|||T:0.0152|Low_complexity_(Seg):Seg|||protein_coding|CCDS2.2||||||YES|SAMD11|HGNC||||||7/14|||1,T|ENSG00000188976|ENST00000477976|Transcript|downstream_gene_variant||||||rs200996316&COSM1344644||||T:0.0152||||retained_intron||||||||NOC2L|HGNC||||||||4768|-1,T|ENSG00000188976|ENST00000327044|Transcript|downstream_gene_variant||||||rs200996316&COSM1344644|ENSP00000317992|||T:0.0152||||protein_coding|CCDS3.1||||||YES|NOC2L|HGNC||||||||4767|-1,T|ENSG00000187634|ENST00000474461|Transcript|upstream_gene_variant||||||rs200996316&COSM1344644||||T:0.0152||||retained_intron||||||||SAMD11|HGNC||||||||1639|1,T|ENSG00000187634|ENST00000466827|Transcript|upstream_gene_variant||||||rs200996316&COSM1344644||||T:0.0152||||retained_intron||||||||SAMD11|HGNC||||||||2666|1,T|ENSG00000188976|ENST00000483767|Transcript|downstream_gene_variant||||||rs200996316&COSM1344644||||T:0.0152||||retained_intron||||||||NOC2L|HGNC||||||||4767|-1,T|ENSG00000187634|ENST00000478729|Transcript|upstream_gene_variant||||||rs200996316&COSM1344644||||T:0.0152||||processed_transcript||||||||SAMD11|HGNC||||||||909|1,T|ENSG00000187634|ENST00000437963|Transcript|downstream_gene_variant||||||rs200996316&COSM1344644|ENSP00000393181|||T:0.0152||||protein_coding||||||||SAMD11|HGNC||||||||3643|1,T|ENSG00000187634|ENST00000420190|Transcript|downstream_gene_variant||||||rs200996316&COSM1344644|ENSP00000411579|||T:0.0152||||protein_coding||||||||SAMD11|HGNC||||||||145|1,T|ENSG00000187634|ENST00000341065|Transcript|intron_variant&feature_elongation||||||rs200996316&COSM1344644|ENSP00000349216|||T:0.0152||||protein_coding||||||||SAMD11|HGNC|||||||5/11||1,T|ENSG00000187634|ENST00000455979|Transcript|frameshift_variant&feature_elongation|162-163|163-164|55|||rs200996316&COSM1344644|ENSP00000412228|||T:0.0152|Low_complexity_(Seg):Seg|||protein_coding||||||||SAMD11|HGNC||||||1/7|||1,T|ENSG00000187634|ENST00000464948|Transcript|upstream_gene_variant||||||rs200996316&COSM1344644||||T:0.0152||||retained_intron||||||||SAMD11|HGNC||||||||2729|1,T||ENSR00001516735|RegulatoryFeature|regulatory_region_variant||||||rs200996316&COSM1344644||||T:0.0152||||||||||||||||||||||

## Here we declare the Heather-to-index (HI) and Index-to-Heather hashes to obtain the fields we are going to parse from the header lines
...
my @accepted_keys=();
	...
	chomp ($line);
		...
		if($line=~/^#/)
		{
			# We extract the consequence (CSQ) keys from its heather line and store them in HI and IH hashes
			...
			# We extract the main heather keys from its heather line and store them in HI and IH hashes
				
			elsif (index($line,'#CHROM')==0) 	
			{
				$line=~/^#(.+)/;
				my @tmp_HI0 = split (/\s+/,$1);
		...
		elsif ($line !~ /^#/)
		{
							...
							#~ print "***$tmp[$HI0_vep{"CHROM"}]\n";
					  		...
					  		# Store the first three keys :CHROM, FILTER and INFO	  
						...
						# First filter; not "patch chromosomes", neither Mitochondrial. Not bad quality variants not variants without CSQ= field.
						
						if((exists($AcceptedChr{"$CHROM"})) && $INFO =~ /CSQ\=/ && $FILTER eq 'PASS')
										...
										{	
											{
												...
												{	
													...
													# We join all the fields and store them in a hash
...
{
	# We decompose the hash and print the outfile withouth header line
