...
frameshift_imputed<-frameshift_imputed[,c(2:7,9:12,14:17,22:24)]
frameshift<-frameshift[,c(2:7,9:12,14:17,22:24)]
...
d2.train.NP<-subset(d2.train[-17], d2.train$group == "Non_Pathogenic_frameshift")
d2.train.P<-subset(d2.train[-17], d2.train$group == "Pathogenic_frameshift")
...
pdf(file="Performance_Frameshifts_imputed.pdf")
