...
rm Decompressing CDS_genomic_coordinates_full_compresed.txt.tar.gz

echo Decompressing snpEff v3_6
mkdir SOFTWARE/snpEff
unzip SOFTWARE/snpEff_v3_6_core.zip -C SOFTWARE/snpEff/
...
unzip SOFTWARE/snpEff/snpEff_v3_6_GRCh37.75.zip -C SOFTWARE/snpEff/
